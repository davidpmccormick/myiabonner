		...
		<div class="span12 clearfix">
			<div class="largecontainer relative graybox">
				...
				<div class="share">
					<p>
						<!-- share link -->
						<a href="#modal-{stockists/entry/@id}" data-toggle="modal">Share</a>
						<!-- end share link -->
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<a style="margin-left:20px;" class="addlink" href="{stockists/entry/@id}&#44;">+Pdf</a>
							</xsl:otherwise>
						</xsl:choose>
						<!-- end add to Pdf -->
						
						<!-- share modal window -->
						<div class="modal hide fade" id="modal-{stockists/entry/@id}" tabindex="-1">
						  <div class="modal-header">
						    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&#215;</button>
						    <h3 id="myModalLabel-{stockists/entry/@id}">Stockists</h3>
						  </div>
						  <div class="modal-body">
							<div class='sharebuttons'>
							<div class='twitter' data-url='{$current-url}' data-text='Myia Bonner stockists' data-title='Tweet'></div>
								<div class='facebook' data-url='{$current-url}' data-text='Myia Bonner stockists' data-title='Like'></div>
							</div>
						  </div>
						</div>		
