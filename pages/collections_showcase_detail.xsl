	...
	<div class="row">
		...
		<xsl:call-template name="stickybuttons">
			<xsl:with-param name="backto">
				<xsl:value-of select="$root" /><xsl:text>/collections/showcase</xsl:text>
			</xsl:with-param>
		</xsl:call-template>
		...
		<div class="span12 clearfix">
			<div class="largecontainer relative">
				...
				<div class="visible-phone">
					<a style="position:absolute;top:-30px;left:-20px;" class="backbutton" href="{$root}/collections/showcase">BACK</a>
			...
			<xsl:apply-templates select="showcasedetail/entry/main-images/item" />
			<div class="largecontainer">
				<h3><xsl:value-of select="showcasedetail/entry/title" /></h3>
			</div>
		</div>
	</div>
</xsl:template>

<xsl:template match="showcasedetail/entry/main-images/item">
